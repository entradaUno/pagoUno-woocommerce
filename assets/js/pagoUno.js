...
let successCallback = function(data) {
    ...
    let dues_val = $('#pagoUno_dues').val().split('-');
...
let tokenRequest = function() {
    ...
    let ccNum = $('#pagoUno_ccNo').val();
    let ccExpDate = $('#pagoUno_expdate').val();
    let cvc = $('#pagoUno_cvc').val();
    let name = $('#pagoUno_ccName').val();
    let docNum = $('#pagoUno_ccDocNum').val();
    let email = $('#pagoUno_email').val();
    ...
    let bDate = $('#pagoUno_birthDate').val();
    let country = $('#pagoUno_country').val();
    let state = $('#pagoUno_state').val();
    let city = $('#pagoUno_city').val();
    let street = $('#pagoUno_street').val();
    let streetNumber = $('#pagoUno_streetNumber').val();
    ...
    if ($("#payment_method_pagouno").is(':checked')) {
        ...
        if (validator) {
            ...
            let body = [];
            let publicKey = php_params.publicKey;
