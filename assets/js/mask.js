...
jQuery(document).ready(($) => {
    setTimeout(function () {
        ...
        var creditCardNumber = document.querySelector('#pagoUno_ccNo');
        var creditCardSecurityCode = document.querySelector('#pagoUno_cvc');
        var creditCardExpires = document.querySelector('#pagoUno_expdate');
        var creditCardDocNumber = document.querySelector('#pagoUno_ccDocNum');
        var creditCardName = document.querySelector('#pagoUno_ccName');
